  ...
  return (
    <>
      <header className="grid gap-8 border-b border-primary/35 pb-10 md:grid-cols-[1fr_auto] md:items-end">
        <div>
          <p className="mb-4 text-sm font-extrabold tracking-[0.16em] text-primary">PUBLIC PHOTO GALLERY</p>
          <h1 className="font-display text-4xl font-bold tracking-[-0.04em] text-primary md:text-5xl">
            大家都能看的相簿
          </h1>
        ...
        {isLoading ? (
          ...
          <div className="grid min-h-80 place-items-center rounded-primary border border-dashed border-primary/45 bg-card p-8 text-center">
            <div>
              ...
              <p className="mt-2 text-sm font-semibold text-muted-foreground">完成後製後，再選擇是否公開。</p>
            </div>
          </div>
        ) : (
