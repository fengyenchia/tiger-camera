    ...
    <article className="group min-w-0">
      ...
      <div className="px-1 pt-4">
        <div className="min-w-0">
          <h3 className="truncate font-title text-xl font-bold text-primary">{photo.title}</h3>
          <p className="mt-1 text-xs font-bold text-foreground/65">{formatPhotoDate(photo.createdAt)}</p>
        </div>
      </div>
    </article>
  );
