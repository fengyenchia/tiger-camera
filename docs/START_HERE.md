...
1. **W0／I0（目前階段）**：依 [`w0-i0-guide.md`](w0-i0-guide.md) 部署最新 Frontend／Backend，用實機手機完成領取、後製、直接下載、公開、放大檢視與管理員刪除；再寫入 NFC 固定網址並測試。
2. **P0**：外接單節 3.7V 鋰電池及 5V 充電／保護／升壓模組，先桌上量測，再裝進機身。
